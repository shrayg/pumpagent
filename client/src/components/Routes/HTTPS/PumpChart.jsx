import { httpsServerPumpChart } from "../../../utils/servercode.js";
import {
  httpsClientPumpChart,
  httpsClientReactPumpChart,
} from "../../../utils/clientcode.js";
import CodeBlock from "../../CodeBlock/CodeBlock";
import BlogNav from "../../BlogNav/BlogNav";
import Parameters from "../../Wrappers/Parameters";
import { httpsPumpChartMetadata } from "../../../utils/codemetadata";
import { useState } from "react";
import Response from "../../Wrappers/Response.jsx";
import Pagination from "../../Pagination/Pagination.jsx";
import { Helmet } from "react-helmet";
import TestChart from "../../../Sandbox/TestChart.jsx";

const PumpChart = () => {
  const { parameters, response } = httpsPumpChartMetadata;
  ...
  return (
    <article className="pt-0 text-[12px] text-white px-5 md:px-10 lg:px-10 flex-1 w-[97vw] xl:max-w-[950px] lg:mx-auto">
      ...
      <Pagination />
      <h1 className="text-5xl lg:text-6xl dark:text-black pb-8">Pump Chart</h1>
      <div className="text-[20px] font-light leading-7 mb-4 md:mb-8 dark:text-black">
        Render an interactive chart of any pump.fun token which is still on it's
        bonding curve.
      </div>
      <TestChart />
      <div className="flex flex-col lg:flex-row w-full justify-center gap-2 md:mt-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-2 mt-4 lg:mt-0">
          <CodeBlock
            language="JavaScript"
            clientCode={httpsClientPumpChart}
            serverCode={httpsServerPumpChart}
            hasToggle={true}
            view={view}
            setView={setView}
          />
          <CodeBlock
            language="React.js"
            clientCode={httpsClientReactPumpChart}
            view={view}
            setView={setView}
          />
        </div>
