import { httpsServerDexPaid } from "../../../utils/servercode.js";
import { httpsClientDexPaid } from "../../../utils/clientcode.js";
import CodeBlock from "../../CodeBlock/CodeBlock";
import BlogNav from "../../BlogNav/BlogNav";
import Parameters from "../../Wrappers/Parameters";
import { httpsDexPaidMetadata } from "../../../utils/codemetadata";
...
const DexPaid = () => {
  ...
  const { parameters, response } = httpsDexPaidMetadata;
  ...
  return (
    <article className="pt-0 text-[12px] text-white px-5 md:px-10 lg:px-10 flex-1 w-[97vw] xl:max-w-[950px] lg:mx-auto">
      ...
      <div className="text-[20px] font-light leading-7 mb-4 md:mb-8 dark:text-black">
        Check if a payment was made to Dexscreener for a token's profile (e.g.,
        banner image and other features).
      </div>

      <div className="flex flex-col lg:flex-row w-full justify-center gap-2 mt-4 md:mt-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-2 mt-4 lg:mt-0">
          <CodeBlock
            language="JavaScript"
            serverCode={httpsServerDexPaid}
            clientCode={httpsClientDexPaid}
            hasToggle={true}
            view={view}
            setView={setView}
          />
