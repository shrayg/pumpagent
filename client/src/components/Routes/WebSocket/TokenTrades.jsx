import { webSocketClientTokenTrades } from "../../../utils/clientcode.js";
import { webSocketServerTokenTrades } from "../../../utils/servercode.js";
  ...
  return (
    <article className="pt-0 text-[12px] text-white px-5 md:px-10 lg:px-10 flex-1 w-[97vw] xl:max-w-[950px] lg:mx-auto">
      ...
      <div className="text-[20px] font-light leading-7 dark:text-black">
        Receive realtime trade data for a list of pump.fun contract addresses.
      </div>
      ...
      <div className="flex flex-col lg:flex-row w-full justify-center gap-2 mt-5 md:mt-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-2 mt-4 lg:mt-0">
          <CodeBlock
            language="JavaScript"
            clientCode={webSocketClientTokenTrades}
            serverCode={webSocketServerTokenTrades}
            hasToggle={true}
            view={view}
            setView={setView}
          />
