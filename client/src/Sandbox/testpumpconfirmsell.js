...
const handleBuy = async () => {
  const sellAmount = (3560 * 1e6).toString();
  console.log("Buy amount: ", sellAmount);
  ...
  try {
    ...
    const createRequest = await fetch(
      "http://localhost:3000/create-pumpfun-sell-transaction",
      {
        method: "POST",
        body: JSON.stringify({
          ca,
    ...
    console.log("Sell success: ", success);
